...
def parse_opt():
    ...
    parser.add_argument('--self_loss_weight_q', type=float, default=0.7, 
                    help='self-supervised loss weight q')
    parser.add_argument('--kl_loss_weight', type=float, default=1,
                    help='self-supervised loss true weight')
    parser.add_argument('--dis_loss_weight', type=float, default=0.05,
                    help='self-supervised loss true weight')
    parser.add_argument('--pos_k', type=int, default=10, help='number of positive k object fea')
    ...
    parser.add_argument('--dataroot', type=str, default='',help='dataroot')
