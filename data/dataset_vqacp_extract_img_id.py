...
class VQAFeatureDataset(Dataset):
    def __init__(self, name, dictionary, dataroot, image_dataroot, ratio, adaptive=False):
        ...
        self.m = MIO("/mnt/cephfs/home/wenzhiquan/code_2020/bottom-up-attention-vqa/trainval_features")
    ...
    def __getitem__(self, index):
        ...
        if None != answer:
            ...
            return features, torch.FloatTensor([0]), question, target, question_id, img_id
        else:
            return features, torch.FloatTensor([0]), question, question_id, img_id
